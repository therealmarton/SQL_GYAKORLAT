--email: email mask
--szulev random mask : 1900 es 2006 kozotti szamok
--cim partial mask: csak az iranyitoszam latszik, a pontos cim nem
CREATE TABLE [dbo].[Ugyfel](
	[LOGIN] [nvarchar](255) NOT NULL,
	[EMAIL] [nvarchar](255) MASKED WITH (function = 'email()') NOT NULL,
	[NEV] [nvarchar](255) NOT NULL,
	[SZULEV] [int] MASKED WITH (function = 'random(1900,2006)') NULL,
	[NEM] [nvarchar](1) NULL,
	[CIM] [nvarchar](255) MASKED WITH (function = 'partial(4,"XXXXXXXX",0)')NULL,
